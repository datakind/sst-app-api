...
class InstTable(Base): # type: ignore[misc]
    ...
    allowed_emails: Mapped[Optional[Dict[str, str]]] = Column(MutableDict.as_mutable(JSON))
    # Schemas that are allowed for validation.
    schemas: Mapped[Optional[List[str]]] = Column(MutableList.as_mutable(JSON))
...
class ApiKeyTable(Base): # type: ignore[misc]
...
class AccountTable(Base): # type: ignore[misc]
    """
...
class AccountHistoryTable(Base): # type: ignore[misc]
...
class FileTable(Base): # type: ignore[misc]
    """The file table""" 
...
class BatchTable(Base): # type: ignore[misc]
    """The batch table"""
...
class ModelTable(Base): # type: ignore[misc]
    """The model table"""
...
class JobTable(Base): # type: ignore[misc]
    """The job table"""
...
class DocType(enum.Enum): # type: ignore[misc]
    base = "base"
    extension = "extension"


class SchemaRegistryTable(Base): # type: ignore[misc]
    """
