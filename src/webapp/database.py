...
class InstTable(Base):
    ...
    __tablename__ = "inst"
    id: Mapped[dict[str, str]] = mapped_column(
    ...
    state: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_LENGTH), nullable=True
    )
    # Only populated for PDP schools.
    pdp_id: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_LENGTH), nullable=True
    )
    created_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), server_default=func.now()
    )
    updated_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), onupdate=func.now()
    )
    created_by: Mapped[dict[str, str]] = mapped_column(
...
class ApiKeyTable(Base):
    ...
    access_type: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_LENGTH), nullable=False
    )
...
class AccountTable(Base):
    ...
    email: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=False, unique=True
    )
    google_id: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=True
    )
    azure_id: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=True
    )

    email_verified_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    password: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=False
    )
    two_factor_secret: Mapped[dict[str, str]] = mapped_column(Text, nullable=True)
    two_factor_recovery_codes: Mapped[dict[str, str]] = mapped_column(
        Text, nullable=True
    )
    two_factor_confirmed_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )

    remember_token: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=True
    )
    # Required for team integration with laravel
    current_team_id: Mapped[dict[str, str]] = mapped_column(
        Uuid(as_uuid=True), nullable=True
    )
    access_type: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_LENGTH), nullable=True
...
class AccountHistoryTable(Base):
    ...
    action: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=False
    )
    resource_id: Mapped[dict[str, str]] = mapped_column(
        Uuid(as_uuid=True), nullable=False
    )
...
class FileTable(Base):
    ...
    source: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_LENGTH), nullable=True
    )
    # The schema type(s) of this file.
    schemas: Mapped[dict[str, str]] = mapped_column(
    ...
    deleted_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    retention_days: Mapped[int] = mapped_column(nullable=True)
...
class BatchTable(Base):
    ...
    updated_by: Mapped[dict[str, str]] = mapped_column(
        Uuid(as_uuid=True), nullable=True
    )
...
class JobTable(Base):
    ...
    # The time the deletion request was set.
    triggered_at: Mapped[dict[str, str]] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    batch_name: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=False
    )
...
class SchemaRegistryTable(Base):
    ...
    version_label: Mapped[dict[str, str]] = mapped_column(
        String(VAR_CHAR_STANDARD_LENGTH), nullable=False
    )
