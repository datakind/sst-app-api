...
def validate_dataset(
    ...
    ext_schema = None
    extension_schema_path = f"src/webapp/validation_schemas/{institution_id}_schema_extension.json"
    ...
    if missing_required or extra_columns:
        if logging:
            logging.error(f"Missing required or extra columns detected, missing_required = {missing_required}, extra_columns = {extra_columns}")
